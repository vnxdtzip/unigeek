...
export const CATALOG = [
  ...
  { slug: "sub-ghz",              title: "Sub-GHz (CC1101)",    category: "module",   summary: "Capture, replay, and jam Sub-GHz RF signals — 38 brand/manufacturer protocol decoders, peak frequency detector, live RAW/Code receive filter, scrollable Signal Info view, KeeLoq auto-decode + counter-step (Replay +1) rolling-code replay; compatible with Flipper Zero .sub format", hasDetail: true,  stable: true },
  ...
  { slug: "remote-access",        title: "Remote Access",       category: "utility",  summary: "Mirror the device screen in a browser and control it over USB serial — navigate, type, and tap from https://unigeek.xid.run/app/remote; needs the Screen Mirror setting on", hasDetail: true,  stable: true },
  ...
  // Settings
  { slug: "setting-general",      title: "General Settings",    category: "setting",  summary: "Device name, display timeout, brightness, volume, navigation sound, theme color, WFM password, Serial File Manager and Screen Mirror serial services on/off (off by default to save SRAM)", hasDetail: true,  stable: true },
